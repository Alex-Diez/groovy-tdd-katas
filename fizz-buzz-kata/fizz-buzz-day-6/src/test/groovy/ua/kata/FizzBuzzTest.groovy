...
class FizzBuzzTest extends Specification {
  ...
  def 'fizz buzz a list that contains a number that is not divisible by 3 nor 5'() {
    when: 'fizz buzz a list'
  ...
  def 'fizz buzz a list that contains a number that is divisible by 3'() {
    when: 'fizz buzz a list'
  ...
  def 'fizz buzz a list that contains a number that is divisible by 5'() {
    when: 'fizz buzz a list'
  ...
  def 'fizz buzz a list that contains a number that is divisible by 3 and 5'() {
    when: 'fizz buzz a list'
