...
class PrimeFactorsTest extends Specification {
  ...
  def 'prime factors of multiplication of two prime numbers contain the prime numbers'() {
    when: 'prime factors are generated'
  ...
  def 'prime factors of multiplication of a prime number on itself contain the prime number many times'() {
    when: 'prime factors are generated'
