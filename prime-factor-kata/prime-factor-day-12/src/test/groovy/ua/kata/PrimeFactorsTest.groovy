...
class PrimeFactorsTest extends Specification {
  ...
  def 'prime factors of a multiplication of two prime numbers contain those prime numbers'() {
    when: 'prime factors are generated'
  ...
  def 'prime factors of a multiplication of prime number by itself contain the prime number many times'() {
    when: 'prime factors are generated'
